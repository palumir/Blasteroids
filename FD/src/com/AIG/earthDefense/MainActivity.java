...
import com.AIG.screenelements.myButton;
...
public class MainActivity extends ActionBarActivity {
	...
	public static double density = 2.5f;
    ...
    void initMain() {
		...
		ScreenElement title =  new ScreenElement("Text","Earth Defense",width/2, height/8,"Main");
		...
		ScreenElement survivalText =  new ScreenElement("Text","Play",width/2,height/4.7f,"Main");
		...
		ScreenElement tutorialText =  new ScreenElement("Text","Tutorial",width/2,height/4.7f + 3*height/20,"Main");
		tutorialText.setTextSize(GameActivity.getScreenWidth()/12);
		prefs = this.getSharedPreferences("flickOffGame", Context.MODE_PRIVATE);
		highScoreText =  new ScreenElement("Text","High Score: " + GameActivity.toTime(prefs.getInt("SurvivalhighScore", 0)),width/2,height/4.7f + 5*height/20,"Main");
