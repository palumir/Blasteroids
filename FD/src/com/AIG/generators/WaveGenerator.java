...
public class WaveGenerator {
	...
	public void buildCircle(Wave w, int n, String unitType, int startingDifference, float spinVal){
	...
	public void buildBombardment(Wave w, int n, String unitType, int startingDifference, float spinVal){
